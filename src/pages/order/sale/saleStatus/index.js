...
import { AtIcon,AtFloatLayout,AtInput,AtTextarea,AtInputNumber  } from 'taro-ui'
import '../index.scss'
export default class Index extends Component {
    ...
    state={
        ...
        reasonList:[{title:"快递一直未送达"},{title:"快递无跟踪记录"},{title:"空包裹"},{title:"其他"}]
    }
            ...
            <View className="sale-container">
                ...
                <View className="sale-item">
                    ...
                    <View className="reason">
                        <Text>请选择收货状态</Text>
                        <AtIcon onClick={this.setOpenReason.bind(this,'openGoodsStaus')} value={`chevron-${openGoodsStaus ? 'up' : 'down'}`} size='22' ></AtIcon>
                    </View>
                </View>
                <View className="sale-item">
                    ...
                    <View className="reason">
                        <Text>请选择退款原因</Text>
                        <AtIcon onClick={this.setOpenReason.bind(this,'openStatus')} value={`chevron-${openStatus ? 'up' : 'down'}`} size='22' ></AtIcon>
                    </View>
                </View>
                <View className="sale-item">
                ...
                <View className="sale-item">
                    <View className="sale-header money">
                        <View>
                            <Text>退款金额</Text><Text className="des">最多1000元</Text>
                        </View>
                        <View>
                            <Text>退换货规则</Text>
                ...
                <AtFloatLayout isOpened={openStatus} onClose={this.setOpenReason.bind(this,'openStatus')}>
                   <View className="layout-item center">退货原因</View>
                   {this.state.reasonList.map((item,index) => {
                       return (<View className="layout-item" key={'item'+index}>{item.title}</View>)
                   })}
                </AtFloatLayout>
                <AtFloatLayout isOpened={openGoodsStaus} onClose={this.setOpenReason.bind(this,'openGoodsStaus')}>
